...
public class AcdmExcelUserPreferencesDownloader {
	
	//select u.PREF_ID,u.USER_OWNR_ID, m.PREF_TYPE, m.PREF_NAME, u.SELECTED_VAL from ACDM_EXCEL_USER_PREF u, ACDM_EXCEL_MASTER_PREF m where u.PREF_ID = m.PREF_ID

	public AcdmExcelUserPreferencesDownloader() {
	}
