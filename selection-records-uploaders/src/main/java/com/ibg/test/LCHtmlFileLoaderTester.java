...
public class LCHtmlFileLoaderTester {
	...
	public void startLoadProcess() {
		...
		try {
			String htmlFileName = prop.getLcDataHome() + "\\html\\lc_solr_qry.html";
	...
	public static void main(String[] args) {
		new LCHtmlFileLoaderTester().startLoadProcess();
	}
